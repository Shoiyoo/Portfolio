                      ...
                      <div className="text-center">
                        ...
                        <div className="grid grid-cols-3 grid-rows-2 gap-6 pt-10 px-9 place-items-center">
                          <div className="box-border w-[286px] h-[166px] p-6 bg-transparent hover:bg-purple-500/50 transition duration-900 ease-in-out text-center hover:scale-115">
                            ...
                            <Image 
                              src="https://i.postimg.cc/wMt895Ry/laravel.png"
                              alt="Logo Laravel" 
                              width={70} 
                              height={30} 
                          ...
                          <div className="box-border w-[286px] h-[166px] p-6 bg-transparent hover:bg-purple-500/50 transition duration-900 ease-in-out text-center hover:scale-115">
                            ...
                            <Image 
                              src="https://i.postimg.cc/tJL0J1Fr/docker.png" 
                              alt="Logo Docker" 
                              width={70} 
                              height={30} 
                              className="mx-auto mt-4" 
                          ...
                          <div className="box-border w-[286px] h-[166px] p-6 bg-transparent hover:bg-purple-500/50 transition duration-900 ease-in-out text-center hover:scale-115">
                            ...
                            <Image 
                              src="https://i.postimg.cc/zf5rTR66/nextjs.png" 
                              alt="Logo Next.js" 
                              width={70} 
                              height={30} 
                              className="mx-auto mt-4" 
                          ...
                          <div className="box-border w-[286px] h-[166px] p-6 bg-transparent hover:bg-purple-500/50 transition duration-900 ease-out text-center hover:scale-115">
                            ...
                            <Image 
                              src="https://i.postimg.cc/hjtR5RS0/mangodb.png" 
                              alt="Logo MongoDB" 
                              width={70} 
                              height={30} 
                              className="mx-auto mt-4" 
                          ...
                          <div className="box-border w-[286px] h-[166px] p-6 bg-transparent hover:bg-purple-500/50 transition duration-900 ease-in-out text-center hover:scale-115">
                            ...
                            <Image 
                              src="https://i.postimg.cc/s2cRmgRX/nodejs.png" 
                              alt="Logo Node.js"
                              width={70} 
                              height={30} 
                              className="mx-auto mt-4" 
                          ...
                          <div className="box-border w-[286px] h-[166px] p-6 bg-transparent hover:bg-purple-500/50 transition duration-900 ease-in-out text-center hover:scale-115">
                            ...
                            <Image 
                              src="https://i.postimg.cc/FFnNwzkk/tailwind.png" 
                              alt="Logo Tailwind" 
                              width={70} 
                              height={30} 
                              className="mx-auto mt-4" 
